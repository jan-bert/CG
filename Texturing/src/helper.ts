...
export enum Textures { earth = "Earth", colors = "Colors", disturb = "Disturb", checker = "Checker", terracotta = "Terracotta", plastic = "Plastic", wood_ceiling = "wood_ceiling", lava = "Lava", rock = "Rock", indoor = "indoor"}
export enum NormalMaps { uniform_normals = "uniform_normals", terracotta_normals = "terracotta_normals", plastic_normals = "plastic_normals", wood_ceiling_normals = "wood_ceiling_normals", lava_normals = "lava_normals", rock_normals = "rock_normals"}
